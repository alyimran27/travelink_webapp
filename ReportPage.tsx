...
export default function ReportPage({ user, units, bookings, expenses, prospects }) {
  ...
  // Penjagaan mandiri: halaman ini menolak sendiri kalau dibuka bukan oleh owner,
  // tidak bergantung hanya pada penyaringan menu di App.jsx.
  if (!bolehLihatUang(user?.role)) {
    return <Kosong pesan="Halaman laporan hanya bisa dibuka oleh Owner." />;
  }
