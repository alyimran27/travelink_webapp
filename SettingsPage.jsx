...
function Tampilan({ user, p }) {
  ...
  async function pilihFile(e) {
    ...
    try {
      const dataUrl = await siapkanLogo(file, setProgres);
      await simpanDoc(COL.settings, SETTINGS_ID, { logoUrl: dataUrl, logoPath: '' });
      ...
      <div className="card">
        ...
        <div className="row wrap" style={{ alignItems: 'flex-start', gap: 18 }}>
          ...
          <div className="grow stack">
            <div className="small dim">Format JPG, PNG, atau WebP. Maksimal 2 MB. Gambar otomatis dikecilkan supaya ringan dibuka dari HP. Logo muncul di layar masuk, sidebar, dan kwitansi PDF.</div>
